...
**Six cohorts. 299 verified alumni records. 52 provinces represented in the parsed directory. One website, built in a day.**
...
| `/alumni` | 299-record alumni directory with search, sector filter, province map, and cohort insights |
...
- **Real data only.** 299 verified alumni records, 52 provinces represented in the parsed directory, 6 cohorts, 42 hours, 7 days, 30+ speakers — all verifiable against depa's official announcements.
