...
const facultyData = [
  {
    ...
    bio: {
      ...
      th: "ผู้เชี่ยวชาญพิเศษของ depa และอดีตรองผู้อำนวยการอาวุโส มีประสบการณ์กว่า 30 ปี และเป็นผู้นำการวางนโยบายเมืองอัจฉริยะระดับชาติของประเทศไทยมาตั้งแต่เริ่มต้น",
    ...
    expanded: {
      ...
      th: "ดร. ภาสกรคือสถาปนิกหลักของกรอบแนวคิดเมืองอัจฉริยะแห่งชาติของไทย รวมถึง City Data Platform (CDP) ที่เชื่อมต่อข้อมูลเทศบาลกว่าหลายสิบเมืองในปัจจุบัน ประสบการณ์กว่า 30 ปีครอบคลุม NECTEC, NSTDA และ depa พร้อมปริญญาเอกด้านสถาปัตยกรรมซอฟต์แวร์จากมหาวิทยาลัยมิสซูรี และดำรงตำแหน่งนายกสมาคมระบบขนส่งและจราจรอัจฉริยะไทย (ITS Thailand) ใน SCL ไม่มีคณาจารย์ท่านใดให้สิ่งที่ท่านให้ได้: ประวัติความเป็นมาของกฎระเบียบ ตรรกะการจัดสรรงบประมาณ และคำอธิบายว่าเหตุใดกรอบแนวคิดระดับชาติจึงถูกสร้างขึ้นในรูปแบบที่เป็นอยู่",
  ...
  },
  {
    ...
    role: { en: "Acting President & CEO, depa", th: "รักษาการผู้อำนวยการใหญ่ depa", cn: "depa 代理总裁兼首席执行官" },
    ...
    bio: {
      ...
      th: "รักษาการผู้อำนวยการใหญ่ของ depa ผู้ขับเคลื่อนหลักสูตร SCL (รวมถึงรุ่นที่ 1 และ 2) และโครงการเมืองอัจฉริยะของประเทศไทย",
    ...
    expanded: {
      ...
      th: "ศึกษาจาก Imperial College London (วิศวกรรมไฟฟ้า) ดร. ศุภกรนำแผนกส่งเสริมเมืองอัจฉริยะของ depa ตั้งแต่ปี 2560 กำกับดูแลการเปิดตัวภูเก็ตในฐานะเมืองอัจฉริยะนำร่องแห่งแรกของไทย และเป็นตัวแทนของไทยใน GSMA Smart Mobility และ ASEAN-Japan Smart Cities Network ในฐานะรักษาการผู้อำนวยการใหญ่ depa ท่านคือเจ้าของหลักสูตร SCL ในเชิงสถาบัน ผู้เข้าร่วม SCL จึงสามารถถามท่านได้โดยตรงว่า depa จะสนับสนุนหรือไม่สนับสนุนสิ่งใด การประกาศเขตเมืองอัจฉริยะใดอยู่ระหว่างการพิจารณา และวาระเมืองอัจฉริยะระดับชาติกำลังมุ่งหน้าไปทางใด",
  ...
  },
  {
    ...
    expanded: {
      ...
      th: "นักวิชาการ Harvard-Yenching ปริญญาเอกมานุษยวิทยาจากฮาร์วาร์ด พร้อมปริญญาเพิ่มเติมจาก MIT และอ็อกซ์ฟอร์ด ดร. นนเป็นผู้เขียน Smart City Primer — ตำราเมืองอัจฉริยะที่เข้าถึงได้มากที่สุดในบริบทอาเซียน — และร่วมออกแบบ SCL มาห้ารุ่นตั้งแต่ปี 2565 งานวิจัยของท่านครอบคลุมย่านประวัติศาสตร์เซี่ยงไฮ้ ทางเดินการสัญจรในกรุงเทพฯ และเมืองรองในอาเซียน โดยใช้วิธีวิจัยเชิงชาติพันธุ์วรรณนาเพื่อทำความเข้าใจว่าประชาชนใช้งานหรือหลีกเลี่ยงโครงสร้างพื้นฐานอัจฉริยะอย่างไร ท่านเป็นผู้สร้าง SCITI และ SLIC การจัดอันดับเมืองทั่วโลก 163 เมือง ในฐานะคณาจารย์เพียงท่านเดียวที่ออกแบบหลักสูตรด้วยตนเอง ท่านจึงอธิบายได้ไม่เพียงว่าหลักสูตรประกอบด้วยอะไร แต่ยังอธิบายได้ว่าเหตุใดจึงเลือกแต่ละองค์ประกอบ",
  ...
  },
  {
    ...
    role: { en: "Executive Vice President, KMITL", th: "รองอธิการบดี, สจล.", cn: "蒙固王理工大学拉甲挽分校（KMITL）执行副校长" },
    ...
    bio: {
      ...
      cn: "蒙固王理工大学拉甲挽分校（KMITL）创新与全球合作执行副校长，专注于智慧城市技术孵化与合作网络的搭建。",
    },
    expanded: {
      ...
      th: "ศึกษาจาก Georgia Tech ดร. รัชนีนำการค้าเชิงพาณิชย์และความร่วมมือวิจัยนานาชาติของ สจล. — แปลงงานวิจัยวิศวกรรมด้าน Machine Learning ระบบสมองกลฝังตัว และหุ่นยนต์ ให้กลายเป็นโซลูชันระดับเมืองที่พร้อมนำไปใช้จริง ผ่านการบ่มเพาะอย่างเป็นระบบ ความร่วมมือกับ DOST ISU (ฟิลิปปินส์) เป็นแบบจำลองสำหรับการถ่ายทอดเทคโนโลยีเมืองอัจฉริยะในระดับอาเซียน ใน SCL ท่านเชื่อมผู้เข้าร่วมเข้ากับสายงานวิจัยและเครือข่ายมหาวิทยาลัยนานาชาติของ สจล. — สิ่งที่หน่วยงานท้องถิ่นไม่สามารถสร้างขึ้นได้เอง",
      cn: "毕业于佐治亚理工学院，Dr. Rutchanee 主管 KMITL 的成果转化与国际研究合作，将机器学习、嵌入式系统与机器人等工程研究通过系统性孵化转化为可部署的城市级解决方案。她与菲律宾 DOST ISU 的合作是东盟层面智慧城市技术转移的范本。在 SCL 中，她为学员搭建通往 KMITL 研究管线和国际大学网络的直接通道——这正是城市政府无法在内部自建的基础设施。",
    },
  ...
  },
  {
    ...
    role: { en: "Mayor of Nakhon Si Thammarat City", th: "นายกเทศมนตรีเมืองนครศรีธรรมราช", cn: "洛坤市市长" },
    ...
    bio: {
      ...
      cn: "洛坤市市长，倡导智慧城市规划、穆斯林友好旅游与基于人工智能的教育。",
    },
    expanded: {
      ...
      th: "ปริญญาเอกด้านวิศวกรรมโยธาจากมหาวิทยาลัยโคโลราโด ดร. กณพเปลี่ยนเมืองที่มักประสบอุทกภัยในภาคใต้ให้กลายเป็นต้นแบบเมืองอัจฉริยะที่ได้รับการยอมรับในระดับนานาชาติ — คว้ารางวัล Best Partnership Award จาก World Smart City Expo 2023 ที่เกาหลีใต้ การพัฒนาของท่านรวมถึงระบบเตือนภัยน้ำท่วมแบบเรียลไทม์ ระบบสื่อสารดิจิทัลสองทางระหว่างประชาชนกับเทศบาล และห้องเรียน Metaverse ในโรงเรียนรัฐ ท่านพูดในเวทีของ UN ESCAP และ UN DESA ใน SCL ท่านคือนายกเทศมนตรีตัวจริงที่ลงมือทำด้วยตนเอง — ไม่ใช่ที่ปรึกษาที่เพียงอธิบายว่านายกเทศมนตรีควรทำอะไร",
      cn: "获科罗拉多大学土木工程博士学位，Kanop 将泰国南部一座饱受洪涝困扰的城市打造为国际认可的智慧城市典范——荣获 2023 年世界智慧城市博览会（韩国）最佳伙伴关系奖。其部署成果包括实时洪水预警平台、市民与市政之间的双向数字沟通系统，以及公立学校的元宇宙课堂。他活跃于联合国亚太经社会（UN ESCAP）与联合国经社部（UN DESA）等论坛。在 SCL 中，他是一位亲自把工程做出来的现任市长——而非纸上谈兵、空谈市长该做什么的顾问。",
    },
  ...
  },
  {
    ...
    expanded: {
      ...
      th: "ผู้ได้รับเครื่องราชอิสริยาภรณ์ Chevalier dans l'Ordre des Palmes académiques ของฝรั่งเศส และผู้อำนวยการ UddC ที่จุฬาลงกรณ์มหาวิทยาลัย ดร. นิรมลนำโครงการ GoodWalk Thailand — ดัชนีความสะดวกในการเดินเท้าที่เข้มงวดที่สุดของประเทศ — และขับเคลื่อนการออกแบบพื้นที่สาธารณะแบบมีส่วนร่วมทั่วกรุงเทพฯ จนเกิดเป็นมาตรฐานเชิงประจักษ์ที่ส่งผลต่อนโยบายเมืองระดับชาติ คำถามวินิจฉัยของท่าน: พื้นที่ทางกายภาพนี้ใช้งานได้จริงสำหรับผู้คนในนั้นหรือไม่? ใน SCL ท่านมอบเครื่องมือวัดในระดับถนนที่เป็นรากฐานของชุดตัวชี้วัดเมืองอัจฉริยะทุกชุด",
  ...
  },
  {
    ...
    expanded: {
      ...
      th: "ผู้นำด้านการปฏิบัติงานดิจิทัลที่ Aurecon Thailand ผู้ร่วมก่อตั้ง BIM Club Thailand และกรรมการบริหารสมาคม BIM ไทย ดร. สรรพวัฒน์เป็นสถาปนิกผู้มีใบอนุญาตในไทย สมาชิก American Institute of Architects และ LEED Accredited Professional บทความวิจัยปี 2568 ที่ผ่านการพิจารณาโดยผู้ทรงคุณวุฒิ ตีพิมพ์ใน International Journal of Construction Management ครอบคลุมการจัดลำดับงาน Digital Twin สำหรับการบริหารอาคารในบริบทการก่อสร้างของไทย ใน SCL ท่านให้กรอบแนวคิดในการประเมินข้อเรียกร้องของผู้ขายอย่างมีวิจารณญาณ — แยกแยะระหว่างความอัจฉริยะด้านโครงสร้างพื้นฐานที่แท้จริง กับการนำเสนอที่ดูดีแต่ไร้สาระ",
      cn: "Aurecon 泰国数字实践主管、BIM Club 泰国联合创始人、泰国 BIM 协会执行委员。Sanphawat 是泰国注册建筑师、美国建筑师学会准会员及 LEED 认证专家。2025 年，他在《国际建设管理杂志》（International Journal of Construction Management）发表同行评审论文，探讨泰国建筑运营场景下的数字孪生实施时序。他在 BIM 与数字孪生落地方面拥有逾二十年经验，横跨商业与基础设施项目。在 SCL 中，他提供批判性评估供应商方案的框架——把真正的基础设施智能与华而不实的“仪表板表演”区分开来。",
    },
  ...
  },
  {
    ...
    bio: {
      en: 'Mayor of Yala Municipality ("Nayok Ah"), leads a people-centric Smart City model with Yala Free WiFi, Big Data dashboards, and dimensions including Smart Governance, Living, Environment, and Energy.',
      th: 'นายกเทศมนตรีนครยะลา ("นายกอ๋า") ผู้นำโมเดลเมืองอัจฉริยะที่เน้นประชาชนเป็นศูนย์กลาง ด้วย Yala Free WiFi แดชบอร์ด Big Data และมิติ Smart Governance, Living, Environment และ Energy',
      cn: '也拉市市长（人称"阿市长"），主导以人为本的智慧城市模式，推动 Yala Free WiFi、大数据仪表板等项目。',
    },
    expanded: {
      ...
      th: "นายกเทศมนตรีนครยะลาสี่สมัย และประธานสันนิบาตเทศบาลแห่งประเทศไทย สำเร็จการศึกษาจากมหาวิทยาลัยควีนส์แลนด์ นายกอ๋า เปลี่ยนเมืองชายแดนที่เผชิญความซับซ้อนด้านการปกครองและความมั่นคงให้กลายเป็นต้นแบบเมืองอัจฉริยะระดับจังหวัดที่ถูกอ้างถึงมากที่สุดในไทย แนวทางการพัฒนาของท่านยึดประชาชนเป็นศูนย์กลาง: Yala Free WiFi ในฐานะโครงสร้างพื้นฐานที่สร้างความเชื่อมโยงทางสังคม ความร่วมมือ Big Data กับ CITYDATA.ai สำหรับสาธารณสุข และรูปแบบการปกครองแบบมีส่วนร่วม ผลงานของท่านได้รับการศึกษาจาก UNICEF และนำเสนอโดย GovInsider ใน SCL ท่านคือหลักฐานว่าธรรมาภิบาลอัจฉริยะทำได้แม้ภายใต้ข้อจำกัดด้านทรัพยากรและความเปราะบางทางสังคม",
      cn: "也拉市连任四届市长，泰国全国市政联盟主席，持有昆士兰大学学位。Pongsak 将一座面临复杂治理与安全挑战的泰南边境城市打造成全国被引用最多的府级智慧城市样板。他的各项举措始终以市民为先：Yala Free WiFi 作为社会凝聚力基础设施，与 CITYDATA.ai 合作的大数据公共卫生管理，以及村民会议等参与式治理形式。其经验已被 UNICEF 纳入研究，并经 GovInsider 报道。在 SCL 中，他证明了：在资源约束与社会脆弱的现实条件下，智慧治理依然行得通。",
    },
